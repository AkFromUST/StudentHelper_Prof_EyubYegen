...
try:
    ...
    linkedin_data = pd.read_parquet("Inputs/joined_filtered_with_url_us.parquet")
    ...
    officer_data = pd.read_csv("Inputs/unmatched_officer.csv")
    ...
    top_10.to_csv("Final/linkedin_officer_2.csv", index=False)
    logger.info("Final output written to \\Final\\linkedin_officer_2.csv")
